...
{
   // Contents of first register are restored from (sp)
   first = state->memory[state->Reg.sp + 0];

   // Contents of second register are restored from (sp+1)
   second = state->memory[state->Reg.sp + 1];
